...
yield_prediction_tp_4_function<-function(fruit_drop_natural_4,
  ...
  #tree losses due to mice (any time in the year)
  tree_losses_mice<-chance_event(mice_risk, 
                                 value_if = round(trees_per_ha_4*(1-mice_damage)),
                                 value_if_not = 0)
  ...
  total_apple_yield_p4<-(trees_per_ha_4 - tree_losses_mice)*
...
yield_prediction_tp_1_function<-function(flower_cluster_1,
                                         ...
                                         fruit_drop_increase_unfavorable_weather_tp1_tp2,
  ...
  fruit_drop_increase_unfavorable_weather_during_blossom<-chance_event(unfavorable_weather_during_blossom_risk,#risk_unfavorable_weather_tp1
                                                                       value_if = fruit_drop_increase_unfavorable_weather_tp1_tp2, #increase_fruit_drop_unfavorable_weather_tp1
                                                                       value_if_not = 0,
                                                                       n=1)
  ...
  frist_drop_1<-frist_drop_rate_1*
    ...
    (1+fruit_drop_increase_unfavorable_weather_during_blossom)
  
  #number of fruits per tree#
  n_fruits_per_tree_tp2_p1<-n_flowers_tp1*
    (1-frost_damage)*
...
quality_tp4_function<-function(n_fruits_4,
  ...
  damaged_apples_tp4<-sample(numbered_apples,size= n_damaged_tp4)
  ...
  percentage_of_sunburn_damage<-min(percentage_of_sunburn_damage_infrastructure*
                                      ...
                                      add_sunburn_removing_leaves,1)
  n_sunburn_apples<-round(n_fruits_4*percentage_of_sunburn_damage)
  sunburn_apples<-sample(numbered_apples,size=n_sunburn_apples)
  ...
  rotting_apples<-sample(numbered_apples,size=n_rotting_apples)
  ...
  color_problem_apples<-sample(numbered_apples,size=n_color_problem_apples)
  ...
  #color_problem_no_cold_apples<-sample(numbered_apples,size=n_color_problem_no_cold_apples)
  ...
  hail_apples<-sample(numbered_apples,size=n_hail_apples)
  ...
  bird_apples<-sample(numbered_apples,size=n_bird_apples)
  ...
  mechanical_apples<-sample(numbered_apples,size=n_mechanical_apples)
  ...
  fruit_scab_apples<-sample(numbered_apples,size=n_fruit_scab_apples)
  ...
  other_fungal_diseases_apples<-sample(numbered_apples,size=n_other_fungal_diseases_apples)
  ...
  codling_moth_apples<-sample(numbered_apples,size=n_codling_moth_apples)
  ...
  aphids_apples<-sample(numbered_apples,size=n_aphids_apples)
  ...
  other_insects_apples<-sample(numbered_apples,size=n_other_insects_apples)
  ...
  bitter_pit_apples<-sample(numbered_apples,size=n_bitter_pit_apples)
  ...
  other_physiological_disorders_apples<-sample(numbered_apples,size=n_other_physiological_disorders_apples)
  ...
  dirty_fruits_apples<-sample(numbered_apples,size=n_dirty_fruits_apples)
  ...
  excessive_russeting_apples<-sample(numbered_apples,size=n_excessive_russeting_apples)
  ...
  fruit_cracking_apples<-sample(numbered_apples,size=n_fruit_cracking_apples)
  ...
  return(list(n_damged_apples=length(damaged_apples_harvest),
...
quality_tp3_function<-function(n_fruits_3,
  ...
  #visibly damaged beforehand
  n_damaged_tp3<-round(n_fruits_3*visibly_damaged_3)
  damaged_apples_tp3<-sample(numbered_apples,size=n_damaged_tp3)
  ...
  ifelse(subset(Management_values,Management_values$management_measure=="removing_leaves")$value==1, add_sunburn_removing_leaves<-add_sunburn_removing_leaves_3, add_sunburn_removing_leaves<-0)
  
  percentage_of_sunburn_damage<-min(percentage_of_sunburn_damage_infrastructure*
                                      (1-sunburn_reduce_kaolin)+
                                      add_sunburn_removing_leaves,1)
  n_sunburn_apples<-round(n_fruits_3*percentage_of_sunburn_damage)
  sunburn_apples<-sample(numbered_apples,size=n_sunburn_apples)
  ...
  percentage_of_rotting_damage<-chance_event(risk_rotting_3,
                                             ...
                                             value_if_not = 0)
  n_rotting_apples<-round(n_fruits_3*percentage_of_rotting_damage)
  rotting_apples<-sample(numbered_apples,size=n_rotting_apples)
  ...
  n_hail_apples<-round(n_fruits_3*percentage_of_hail_damage)
  hail_apples<-sample(numbered_apples,size=n_hail_apples)
  ...
  percentage_of_bird_damage<-chance_event(risk_bird_3,
                                          ...
                                          value_if_not = 0)
  n_bird_apples<-round(n_fruits_3*percentage_of_bird_damage)
  bird_apples<-sample(numbered_apples,size=n_bird_apples)
  ...
  percentage_of_mechanical_damage<-chance_event(risk_mechanical_3,
                                                ...
                                                value_if_not = 0)
  n_mechanical_apples<-round(n_fruits_3*percentage_of_mechanical_damage)
  mechanical_apples<-sample(numbered_apples,size=n_mechanical_apples)
  ...
  percentage_of_fruit_scab_damage<-chance_event(risk_fruit_scab_3,
                                                ...
                                                value_if_not = 0)
  n_fruit_scab_apples<-round(n_fruits_3*percentage_of_fruit_scab_damage)
  fruit_scab_apples<-sample(numbered_apples,size=n_fruit_scab_apples)
  ...
  percentage_of_other_fungal_diseases_damage<-chance_event(risk_other_fungal_diseases_3,
                                                           ...
                                                           value_if_not = 0)
  n_other_fungal_diseases_apples<-round(n_fruits_3*percentage_of_other_fungal_diseases_damage)
  other_fungal_diseases_apples<-sample(numbered_apples,size=n_other_fungal_diseases_apples)
  ...
  percentage_of_codling_moth_damage<-chance_event(risk_codling_moth_3,
                                                  ...
                                                  value_if_not = 0)
  n_codling_moth_apples<-round(n_fruits_3*percentage_of_codling_moth_damage)
  codling_moth_apples<-sample(numbered_apples,size=n_codling_moth_apples)
  ...
  percentage_of_aphids_damage<-chance_event(risk_aphids_3,
                                            ...
                                            value_if_not = 0)
  n_aphids_apples<-round(n_fruits_3*percentage_of_aphids_damage)
  aphids_apples<-sample(numbered_apples,size=n_aphids_apples)
  ...
  percentage_of_other_insects_damage<-chance_event(risk_other_insects_3,
                                                   ...
                                                   value_if_not = 0)
  n_other_insects_apples<-round(n_fruits_3*percentage_of_other_insects_damage)
  other_insects_apples<-sample(numbered_apples,size=n_other_insects_apples)
  ...
  n_bitter_pit_apples<-round(n_fruits_3*percentage_of_bitter_pit_damage)
  bitter_pit_apples<-sample(numbered_apples,size=n_bitter_pit_apples)
  ...
  n_other_physiological_disorders_apples<-round(n_fruits_3*percentage_of_other_physiological_disorders_damage)
  other_physiological_disorders_apples<-sample(numbered_apples,size=n_other_physiological_disorders_apples)
  ...
  percentage_of_excessive_russeting_damage<-chance_event(risk_excessive_russeting_3,
                                                         ...
                                                         value_if_not = 0)
  n_excessive_russeting_apples<-round(n_fruits_3*percentage_of_excessive_russeting_damage)
  excessive_russeting_apples<-sample(numbered_apples,size=n_excessive_russeting_apples)
  ...
  percentage_of_fruit_cracking_damage<-chance_event(risk_fruit_cracking_3,
                                                    ...
                                                    value_if_not = 0)
  n_fruit_cracking_apples<-round(n_fruits_3*percentage_of_fruit_cracking_damage)
  fruit_cracking_apples<-sample(numbered_apples,size=n_fruit_cracking_apples) 
  ...
  return(list(n_damged_apples_tp4_p3=length(damaged_apples_tp4_p3),
...
quality_tp2_function<-function(n_fruits_2,
  ...
  #visibly damaged beforehand
  n_damaged_tp2<-round(n_fruits_2*visibly_damaged_2)
  damaged_apples_tp2<-sample(numbered_apples,size=n_damaged_tp2)
  ...
  bad_seed_deformation_apples<-sample(numbered_apples,size=n_bad_seed_deformation_apples)
  ...
  return(list(n_damged_apples_tp3_p2=length(damaged_apples_tp3_p2),
...
quality_tp1_function<-function(flower_cluster_1,
  ...
  n_flowers_1<-flower_cluster_1*flowers_per_cluster_1
  ...
  frost_apples<-sample(numbered_apples,size=n_frost_damage_apples)
  ...
  insect_apples<-sample(numbered_apples,size=n_insect_damage_apples)
  ...
  damaged_apples_tp2_p1<-unique(c(frost_apples,
                                  insect_apples,
                                  mechanical_apples))
  percentage_damaged_at_tp2_p1<-length(damaged_apples_tp2_p1)/n_flowers_1
  
  
  return(list(n_damged_apples_tp2_p1=length(damaged_apples_tp2_p1),
