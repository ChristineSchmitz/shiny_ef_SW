...
library(bslib)
library(reactable)
Apple_input<-read.csv2("apple_quality_input_v7.csv", colClasses = c("character", "character", "numeric", "character","numeric", "character","character","character","character"), sep = ";", dec = ".")
Apple_estimation<-read.csv2("apple_estimation_v3.csv",colClasses = c("character", "character", "numeric", "character","numeric", "character","character","character","character"), sep = ";", dec = ".")
...
server <- function(input, output) {
  ...
  output$TP1 <- renderPlot({
    ...
    tp_1_quality_and_yield_prediction<-function(){
      ...
      return(list(n_damaged_apples_per_tree=quality_prediction$n_damaged_apples,
                  percentage_damaged_at_harvest=quality_prediction$percentage_damaged_at_harvest,
                  total_yield=yield_prediction$yield_at_harvest,
                  total_yield_diameter=yield_prediction$yield_at_harvest_diameter,
                  mean_fruit_weight_at_harvest=yield_prediction$mean_fruit_weight_at_harvest,
                  fruits_per_tree=yield_prediction$number_of_apple_harvested_per_tree,
                  high_quality_yield=quality_yield,
                  high_quality_yield_diameter=quality_yield_diameter,
                  mean_fruit_diameter_at_harvest=yield_prediction$mean_fruit_diameter_at_harvest,
                  mean_fruit_weight_at_harvest_diameter=yield_prediction$mean_fruit_weight_at_harvest_diameter,
